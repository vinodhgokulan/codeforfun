...
<div id="main">
	...
	<div id="cols" class="box">
			...
			<div class="padding box">
				...
				<form action="../search" method="post" id="search">
					<fieldset>
						...
						<p><input type="text" size="17" name="uid" class="input-text" />&nbsp;<input type="submit" value="GO" class="input-submit-02" /><br />
						...
						<div id="search-options" style="display:none;">
								...
								<p>
								<label><input type="radio" name="Uaction" value="view" />View</label><br />
								<label><input type="radio" name="Uaction" value="edit"/> Edit</label><br />
								<label><input type="radio" name="Uaction" value="delete"/> Delete</label><br />
		...
		<div id="content" class="box">
			...
			<fieldset>
				<legend>Create New User Records</legend>
				<table class="nostyle">
				...
				<!-- Connecting to DB to Retrieve Next User-ID -->
					...
					<tr>
						...
						<td><input type="text" size="8" name="uid"  disabled="disabled" value="<%= nextUID %>" class="input-text"  /></td>
