...
<head>
	...
	<title>Report | Buissness Management System | Powered by Samgha IT Services</title>
</head>
...
<div id="main">
	...
	<div id="menu" class="box">
		...
		<ul class="box">
			...
			<li id="menu-active"><a href="#"><span>Report</span></a></li>
 ...
 <p id="btn-create" class="box"><a href="javascript:window.print()" name=print><span>Print Report</span></a></p> 
