 ...
 <p id="btn-create" class="box"><a href="javascript:window.print()" name=print><span>Print Indent</span></a></p> 
		...
		<div id="content" class="box">
			...
			<!-- Form -->
				...
				<form action="updateIndent" method="post" >
			<fieldset>
				...
				<table class="nostyle">
				     ...
				     String date = indent.getDate();%>
					<tr>
						<td style="width:70px;">Intent Number:</td>
						<td><input type="text" size="5" name="IndentNo"  value="<%= indent.getIndentNo() %>" class="input-text" readonly ="readonly"/></td>
					
						
					</tr>
					<tr>
						<td style="width:70px;">Date:</td>
						<td><input type="text" size="10" name="Date" value="<%= indent.getDate()%>"class="input-text" id="inputField"/></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="text" size="5" name ="FCMGrades" value="<%= indent.getFCMGrades() %>" class="input-text"/></td>
					</tr>
					<tr>
						<td style="width:70px;" align ="center">SM</td>
						<td style="width:100px;" align ="center">Number OF Grades:</td>
						<td><input type="text" size="5" name ="SMGrades" value="<%= indent.getSMGrades() %>"class="input-text"/></td>
					</tr>
					<tr>
						<td style="width:70px;" align ="center" >TM</td>
						<td style="width:100px;" align ="center">Number of Grades:</td>
						<td><input type="text" size="5" name ="TMGrades" value="<%= indent.getTMGrades() %>" class ="input-text"/></td>
					</tr>
					<tr>
						<td style="width:70px;" align ="center">DTM</td>
						<td style="width:100px;" align ="center" >Number of Grades:</td>
						<td><input type="text" size="5" name ="DTMGrades" value="<%= indent.getDTMGrades() %>" class="input-text" /></td>
					</tr>
					<tr>
						<td style="width:70px;" class="va-top">Total Grades:</td>
						<td><input type="text" size="10" name ="TotalGrades" value="<%= indent.getTotalGrades() %>" class="input-text"/></td>
					</tr>
					<tr>
						<td style="width:70px;" class="va-top">Total Liters:</td>
						<td><input type="text" size="10" name ="TotalLiters" class="input-text"  value="<%= indent.getTotalLiters() %>"/></td>
					</tr>
					
					<tr>
						<td colspan="2" class="t-right"><input type="submit" class="input-submit" value="Update Indent Details"/></td>
						<td><input type="hidden" name="context" value="updateIndent"/></td>
					</tr>
