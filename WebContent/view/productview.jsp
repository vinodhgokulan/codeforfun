...
<div id="main">
	...
	<tr>
					...
					<tr>
						...
						<td><input type="text" size="5" name="prodname" value="<%=product.getProdName() %>" class="input-text" readonly="readonly" /></td>
					...
					<tr>
						...
						<input type="radio"readonly="readonly" name="ptype" value="Milk" <%= active %>/> Milk<br />
						<% active=""; %>
						<%  if(product.getProdType().equals("Butter")){active ="checked"; }%>
                        <input type="radio" name="ptype" readonly="readonly" value="Butter" <%= active %> /> Butter
						</td>
					</tr>
					<tr>
						<td style="width:70px;">Cost / Unit:</td>
						<td><input type="text" size="15" name="prodcost"readonly="readonly" value="<%= product.getProdCost()%>" class="input-text"  /></td>
					</tr>
				</table>
			</fieldset>
			</form>
