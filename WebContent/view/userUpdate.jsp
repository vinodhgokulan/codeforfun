...
<div id="main">
			...
			<fieldset>
				...
				<% User user=(User)request.getAttribute("setattribute");
					...
					<tr>
						...
						<td>Mobile Number:</td>
						<td><input type="text" size="10" name="umob" class="input-text"  value="<%= user.getUserMob()%>"/></td>
					</tr>
					<tr>
					    <td style="width:180px;">User Name:</td>
						<td><input type="text" size="20" name="uname"  class="input-text"   value="<%= user.getUserName()%>"/></td>
						
						<td style="width:70px;">Landline:</td>
						<td><input type="text" size="15" name="uphone" class="input-text"   value="<%= user.getUserPhone()%>"/></td>
					</tr>
					<tr>
						<td style="width:70px;" class="va-top">Address:</td>
						<td><textarea cols="20" rows="4"  name ="uaddr" class="input-text"><%= user.getUserAddr()%></textarea></td>
					</tr>
					<tr>
						<td>Select User:</td>
						<td >
						 <% String active =""; if(user.getUserType().equalsIgnoreCase("Retailer")){ active ="checked";}%>
						<input type="radio" name="utype" value="Retailer" <%= active %>/> Retailer <br />
						<% active=""; %>
						 <%  if(user.getUserType().equals("Sub-Dealer")){ active ="checked";}%>
                        <input type="radio" name="utype" value="Sub-Dealer" <%= active %>/> Sub-Dealer
                        	<% active=""; %>
						</td>
					</tr>
					<tr>
	...
	<tr>
						...
						<input type="text" size="3" name ="ComFCM"  class="input-text"  value="<%= user.getComFCM()%>"/>
						</td>
					...
					<tr>
						...
						<input type="text" size="3" name ="ComSM"  class="input-text"  value="<%= user.getComSM()%>"/>
						</td>
					...
					<tr>
						...
						<input type="text" size="3" name ="ComTM"  class="input-text"  value="<%= user.getComTM()%>"/>
						</td>
					...
					<tr>
						...
						<input type="text" size="3" name ="ComDTM"  class="input-text"  value="<%= user.getComDTM()%>"/>
						</td>
						
					</tr>
					<tr>
						<td colspan="2" class="t-right"><input type="submit" class="input-submit" value="Update User Details"/></td>
						<td><input type="hidden" name="context" value="updateUser"/></td>
					</tr>
